<aside class="w-54 bg-white border-r border-gray-100 min-h-screen flex flex-col shadow-sm">
    ...
    <div class="flex-1 px-4 py-6 space-y-6 overflow-y-auto custom-scrollbar">
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="{{ route('dashboard') }}" class="group flex items-center px-4 py-3 bg-blue-50 text-blue-600 rounded-xl font-bold transition-all duration-300 hover:translate-x-2">
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="{{ url('/transaksi/tambah') }}" class="group flex items-center px-4 py-3 {{ request()->is('transaksi/tambah') ? 'bg-blue-50 text-blue-600' : 'text-gray-500' }} rounded-xl transition-all duration-300 hover:bg-blue-50 hover:text-blue-600">
